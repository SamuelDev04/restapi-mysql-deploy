...
exports.updateTask = exports.pingTask = exports.findOneTask = exports.findAllTasks = exports.deleteTask = exports.createTask = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          name = req.body.name;
          _context.next = 4;
          return _db.pool.query("INSERT INTO users (name) VALUES ('".concat(name, "')"));
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _db.pool.query("SELECT * FROM users");
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          id = req.params.id;
          _context3.next = 4;
          return _db.pool.query("SELECT id, name FROM users WHERE id = ".concat(id));
        case 4:
...
var pingTask = /*#__PURE__*/function () {
  ...
  return function pingTask(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.pingTask = pingTask;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          name = req.body.name;
          _context5.next = 5;
          return _db.pool.query("UPDATE users SET name = ('".concat(name, "') WHERE id = ").concat(id));
        case 5:
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          id = req.params.id;
          _context6.next = 4;
          return _db.pool.query("DELETE FROM users WHERE id = ".concat(id));
        case 4:
